      ...
      <div className="mx-auto max-w-6xl px-5">
        <div className="relative overflow-hidden rounded-3xl glass-strong p-10 text-center shadow-elevated md:p-20 border-gradient">
          ...
          <h2 className="mx-auto mt-5 max-w-3xl text-4xl font-semibold tracking-tight md:text-6xl">
            Your competitors are already <span className="text-gradient-primary">upgrading.</span>
          </h2>
          <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground">
            While others stay outdated, QoreLabs helps businesses evolve into
            AI-powered companies. Let's see what's possible for yours.
          </p>
          ...
          <p className="mt-8 text-xs text-muted-foreground/80">
            30-min call · no pitch · personalized audit included
          </p>
        </div>
      </div>
    </section>
