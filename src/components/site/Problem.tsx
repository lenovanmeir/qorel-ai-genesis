    ...
    <section className="relative py-28">
      <div className="mx-auto max-w-7xl px-5">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-5 text-lg text-muted-foreground">{t.problem.sub}</p>
        </div>
        ...
        <div className="mt-16 grid gap-6 md:grid-cols-2">
          <div className="group relative overflow-hidden rounded-2xl glass p-3">
            ...
            <img src={oldSite} alt="" className="w-full rounded-xl grayscale transition duration-700 group-hover:grayscale-0" loading="lazy" width={1280} height={800} />
          </div>
          <div className="group relative overflow-hidden rounded-2xl glass-strong p-3 border-gradient">
            ...
            <img src={newSite} alt="" className="w-full rounded-xl" loading="lazy" width={1280} height={800} />
          </div>
        </div>
