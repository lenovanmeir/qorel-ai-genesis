      ...
      <div className="mx-auto max-w-7xl px-5">
        <div className="grid items-center gap-12 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-5 max-w-xl text-lg text-muted-foreground">{t.loom.sub}</p>
          ...
          <div className="relative">
            ...
            <div className="relative overflow-hidden rounded-2xl glass-strong p-2 shadow-elevated border-gradient">
              <div className="relative">
                <img src={loom} alt="" className="w-full rounded-xl" loading="lazy" width={1280} height={800} />
                <button aria-label="Play preview" className="absolute inset-0 grid place-items-center">
              ...
              <div className="flex items-center justify-between px-3 py-3 text-xs text-muted-foreground">
                <span className="font-mono">{t.loom.filename}</span>
                <span>{t.loom.meta}</span>
              </div>
            </div>
          </div>
        </div>
