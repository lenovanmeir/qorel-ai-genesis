              ...
              <div className="grid gap-8 lg:grid-cols-[1.2fr_1fr]">
                <div>
                  ...
                  <dl className="mt-7 grid gap-4 sm:grid-cols-2">
                    <div>
                      <dt className="text-xs uppercase tracking-widest text-destructive/80">{t.cases.beforeLabel}</dt>
                      <dd className="mt-1 text-sm text-muted-foreground">{c.before}</dd>
                    </div>
                    <div>
                      <dt className="text-xs uppercase tracking-widest text-primary">{t.cases.afterLabel}</dt>
