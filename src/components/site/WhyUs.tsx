    ...
    <section id="why" className="relative py-28">
      <div className="mx-auto max-w-7xl px-5">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-5 text-lg text-muted-foreground">{t.why.subtitle}</p>
        </div>
        ...
        <div className="mt-16 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {t.why.items.map((it, i) => {
            const Icon = icons[i];
            return (
              <div key={it.title} className="group relative overflow-hidden rounded-xl glass p-6 transition-all hover:-translate-y-1">
